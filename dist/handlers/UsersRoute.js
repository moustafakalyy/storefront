...
var UsersAuthenticate_1 = __importDefault(require("./UsersAuthenticate"));
...
users.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, token, userModel, response, err_1;
...
users.get("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, token, userModel, response, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                try {
...
users.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, userModel, newUser, secret, token, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                user = {
            ...
            case 2:
                ...
                token = jsonwebtoken_1.default.sign(newUser, secret);
                res.json(token);
                return [3 /*break*/, 4];
            case 3:
                err_3 = _a.sent();
